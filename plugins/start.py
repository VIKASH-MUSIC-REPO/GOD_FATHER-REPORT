...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='🌷 Uᴘᴅᴀᴛᴇs 🌷', url='https://t.me/GOD_KI_DUNIYA'), InlineKeyboardButton(text='🌷 Aʙᴏᴜᴛ 🌷', callback_data='about')],
        [InlineKeyboardButton(text='🌷 Dᴇᴠᴇʟᴏᴘᴇʀ 🌷', url='https://t.me/lll_GOD_FATHER_PAPA_lll')]
        ]
